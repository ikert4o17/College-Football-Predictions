"""
Calculate an initial 2024 FBS power rating.

This mirrors the 2025 baseline rating system
so the two seasons can be compared directly.
"""
...
def calculate_power_ratings():
    """Calculate initial 2024 power ratings."""
